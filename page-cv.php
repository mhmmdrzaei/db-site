        ...
        <div class="cvAttacher">
        	<?php 
            	       ...
            	       if( $file ): ?>
            	         ...
            	         <a href="<?php echo $file['url']; ?>"><?php echo $file['filename']; ?>Click Here to Download a PDF version of My CV</a>
            	    
            	       <?php endif; ?>
        </div>
                 

       <div class="cvContent"> <?php the_content(); ?></div>
